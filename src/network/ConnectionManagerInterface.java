...
/**
 * An interface used in the {@code Client} and {@code Server} classes to dispatch
...
public interface ConnectionManagerInterface
{
   ...
   */
  public abstract void failedToStart(Server server, Client client);
   ...
   * @param connector The connector that resulted from the connection, a {@code Client}
   *  if this is a client or a {@code ServerListener} if this is a server
   */
  public abstract void connected(AbstractConnector connector);
   ...
   *  <code>null</code>
   */
  public abstract void disconnected(AbstractConnector connector, byte reason, String message);
}
